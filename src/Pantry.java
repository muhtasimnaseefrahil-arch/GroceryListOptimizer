public class Pantry extends GroceryItem implements Perishable
{
    private String type = "Pantry";
    private int daysUntilSpoiled;
    private boolean inFridge;

    public Pantry(String Name, int Quantity, int DaysUntilSpoiled, boolean InFridge)
    {
        super(Name,Quantity);
