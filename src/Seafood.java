public class Seafood extends GroceryItem implements Perishable
{
    private String type = "Seafood";
    private int daysUntilSpoiled;
    private boolean inFridge;

    public Seafood(String Name, int Quantity, int DaysUntilSpoiled, boolean InFridge)
    {
        super(Name,Quantity);
